...
namespace MMS.UI.Default
{
    public class Table : System.Windows.Controls.Control
    {
        ...
        private static System.Collections.Generic.Dictionary<Type, ResourceDictionary> _ResourceDictionarys = new System.Collections.Generic.Dictionary<Type, ResourceDictionary>();

        private Grid mainTable;

        public Table()
        {
            //this.ManualApplyTemplate("TableStyle", this.GetType().Assembly);
        ...
        {
            this.Source = "[{\"id\":\"1\",\"Name\":\"李贵发\",\"Age\":\"23\"},{\"id\":\"2\",\"Name\":\"张山\",\"Age\":\"63\"},{\"id\":\"3\",\"Name\":\"王二\",\"Age\":\"41\"}]";
            if (this.Source != null)
            {
                this.UpdateContext();
            }
        ...
        //public ResourceDictionary ManualApplyTemplate(string baseName, Assembly assembly)
        //{
        //    System.Resources.ResourceManager manager = new System.Resources.ResourceManager("", assembly);
        //    System.IO.UnmanagedMemoryStream stream = manager.GetStream("Themes/generic.xaml", System.Globalization.CultureInfo.CurrentUICulture);
        ...
        {
            //<Grid ShowGridLines="False" Name="mainTable">
            //this.mainTable = new Grid();
            //this.mainTable.ShowGridLines = false;
            //this.Content = this.mainTable;
